...
const OurWork = ({
  ...
  heading = (
    <>
      ...
      <span tw="text-primary-500"> Professional Engineers.</span>
    </>
  ),
  description = 'Our Professional engineers design and develop custom digital business software, provide end-to-end solutions tailored to meet specific requirements and support business goals to ensure optimal functionality and efficiency.',
  ...
  const defaultFeatures = [
    {
      ...
      description:
        'We have the best professional engineers people across the globe just to work with you.',
    },
    {
      Icon: MoneyIcon,
      title: 'Affordable',
